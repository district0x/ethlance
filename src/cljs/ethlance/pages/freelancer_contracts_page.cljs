...
(defn freelancer-invitations [{:keys [:user/id]}]
  [contracts-table
   {:list-subscribe [:list/freelancer-invitations]
    ...
    :all-ids-subscribe [:list.ids/freelancer-invitations]
    :title "Invitations"
    :no-items-text "You have no job invitations"}])

(defn freelancer-proposals [{:keys [:user/id]}]
  [contracts-table
   {:list-subscribe [:list/freelancer-proposals]
    :show-proposal? true
    :show-rate? true
    :show-job? true
...
(defn freelancer-contracts-open [{:keys [:user/id]}]
  [contracts-table
   {:list-subscribe [:list/freelancer-contracts-open]
    ...
    :all-ids-subscribe [:list.ids/freelancer-contracts-open]
    :title "Active Contracts"
    :no-items-text "You have no active contracts"}])

(defn freelancer-contracts-done [{:keys [:user/id]}]
  [contracts-table
   {:list-subscribe [:list/freelancer-contracts-done]
    :show-contract? true
    ...
    :all-ids-subscribe [:list.ids/freelancer-contracts-done]
